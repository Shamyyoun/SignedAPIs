...
if (isset($_POST['name']) && isset($_POST['password']) && isset($_POST['id']) && isset($_POST['day']) && isset($_POST['logout_time'])) {
    ...
    if (empty($name) || empty($password) || empty($id) || empty($day) || empty($logout_time)) {
    ...
    $logout_time = strip_tags($logout_time);
    ...
    if (mysqli_num_rows($result1) > 0) {
        ...
        if (mysqli_num_rows($result2) > 0) {
            ...
            $sql3 = "UPDATE employees_log SET logout_time = '" . mysqli_real_escape_string($con, $logout_time) . "' WHERE id = " . $day_id;
            ...
            $sql3 = "INSERT INTO employees_log (day, logout_time, employee_id)"

                    . " VALUES ('" . mysqli_real_escape_string($con, $day) . "',"

                    . " '" . mysqli_real_escape_string($con, $logout_time) . "',"
